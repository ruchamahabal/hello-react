...
class AboutUs extends React.Component {
	...
	render() {
		...
		return (
			<div className="centered-div flex min-h-screen flex-col items-center justify-center gap-7 p-4 font-bold leading-7">
				<h2 className="text-2xl">Team {this.state.team_name}</h2>
				<Outlet />
			</div>
		);
	}
